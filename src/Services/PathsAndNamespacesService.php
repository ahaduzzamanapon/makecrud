...
class PathsAndNamespacesService
{
    ...
    public function getmakecrudViewsStub()
    {
        return resource_path('makecrud'.DIRECTORY_SEPARATOR.'views');
    }

    public function getmakecrudViewsStubCustom($templateViewsDirectory)
    {
        return $this->getmakecrudViewsStub().DIRECTORY_SEPARATOR.$templateViewsDirectory;
    }
    ...
    {
        $stubPath = resource_path('makecrud/commentable/comment-block.stub');
    ...
    {
        return config('makecrud.paths.service.namespace') ?? $rootNamespace.'Services';
    }
    ...
    {
        return config('makecrud.paths.service.path') ?? $this->getRealpathBase('app').DIRECTORY_SEPARATOR.'Services';
    }
