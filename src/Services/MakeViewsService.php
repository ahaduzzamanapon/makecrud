...
namespace ahaduzzamanapon\makecrud\Services;
...
class MakeViewsService
{
    ...
    public function findAndReplaceIndexViewPlaceholderColumns($columns, $templateViewsDirectory, $namingConvention, $separateStyleAccordingToActions, $withLivewire, $columnInSearch)
    {
        ...
        $indexStub =  $withLivewire
                    ? File::get($this->pathsAndNamespacesService->getmakecrudViewsStubCustom($templateViewsDirectory).DIRECTORY_SEPARATOR.'livewire'.DIRECTORY_SEPARATOR.'index-datatable.stub')
                    : File::get($this->pathsAndNamespacesService->getmakecrudViewsStubCustom($templateViewsDirectory).DIRECTORY_SEPARATOR.'index.stub');
    ...
    public function findAndReplaceIndexViewPlaceholderLivewire($templateViewsDirectory, $namingConvention, $separateStyleAccordingToActions, $withLivewire)
    {
        if($withLivewire)
        {
            $indexStub = File::get($this->pathsAndNamespacesService->getmakecrudViewsStubCustom($templateViewsDirectory).DIRECTORY_SEPARATOR.'index-livewire.stub');
    ...
    public function findAndReplaceCreateViewPlaceholderColumns($columns, $templateViewsDirectory, $namingConvention, $separateStyleAccordingToActions)
    {
        ...
        $createStub = File::get($this->pathsAndNamespacesService->getmakecrudViewsStubCustom($templateViewsDirectory).DIRECTORY_SEPARATOR.'create.stub');
    ...
    {
        $showStub = File::get($this->pathsAndNamespacesService->getmakecrudViewsStubCustom($templateViewsDirectory).DIRECTORY_SEPARATOR.'show.stub');
    ...
    public function findAndReplaceEditViewPlaceholderColumns($columns, $templateViewsDirectory, $namingConvention, $separateStyleAccordingToActions)
    {
        ...
        $editStub = File::get($this->pathsAndNamespacesService->getmakecrudViewsStubCustom($templateViewsDirectory).DIRECTORY_SEPARATOR.'edit.stub');
