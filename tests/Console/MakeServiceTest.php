...
class MakeServiceTest extends TestCase
{
    ...
    {
        config()->set('makecrud.paths.service.path', app_path('Services2'));
        config()->set('makecrud.paths.service.namespace', "App\Services2");
    ...
    public function test_create_service_without_config_file()
    {
        ...
        config()->unset('makecrud.paths.service.path');
        config()->unset('makecrud.paths.service.namespace');
